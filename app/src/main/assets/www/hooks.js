...
var gradle = gradle || {
    ...
    event: function(ev, msg){ gradle.process(ev,msg);switch(ev){
		...
		case 'first_start':
			//gradle.showInter();
			break;
		case 'quickGame':   //button quick play
			gradle.showInter();
			break;
		case 'selectLevel':   //button select level
			gradle.showInter();
			break;
		case 'categorySelectTouch':   //select a category 
			//gradle.showInter();
			break;
		case 'settingsFromGame':   //button settings
			//gradle.showInter();
			break;
		case 'restartGame':   //button restart
			gradle.showInter();
			break;
		case 'hintFromGame':   //button hint
			gradle.showInter();
			break;
		case 'about':   //button about
			//gradle.showInter();
			break;
		case 'SCREEN_LEVELRESULT': //event on button sound
			gradle.checkInterval() && gradle.showInter();
			break;
		case 'nextFromGameComplete':   //button next
			//gradle.showInter();
			break;
		case 'test':
			//gradle.checkInterval() && gradle.showInter();
